...
export const GAMEQUERY_SOCKET_TIMEOUT_MS = parseEnvInt(
  process.env.GAMEQUERY_SOCKET_TIMEOUT_MS,
  5000,
  500,
);
...
export const FIVEM_MAX_RESPONSE_BYTES = parseEnvInt(
  process.env.FIVEM_MAX_RESPONSE_BYTES,
  1048576,
  1024,
);
